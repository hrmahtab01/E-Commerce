              ...
              <div>
                <div>
                  ...
                  <div className="w-[399px] h-[180px] border-2 border-primaryColor/50 rounded-[4px] mt-[40px]">
                    <div className="pt-[24px] pb-[16px] border-b border-primaryColor">
                      <div className="flex items-center pl-[16px] gap-4">
                        ...
                        <div>
                          ...
                          <input
                            className="text-[12px] text-primaryColor w-[276px] h-[18px] font-medium font-poppins border-b border-primaryColor mt-2 outline-none placeholder:text-[12px] placeholder:text-primaryColor placeholder:font-medium placeholder:font-poppins"
