        ...
        <div className="mt-20 flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:w-2/3">
            <div className="flex flex-col gap-4 lg:w-1/4">
              {[productOneimage, productTwoimage, productThreeimage, productFourimage].map((image, index) => (
                <div key={index} className="w-full h-[138px] bg-Secondary rounded-md overflow-hidden">
                  <img className="object-cover w-full h-full" src={image} alt={`Product Image ${index + 1}`} />
                </div>
              ))}
            </div>
          ...
          <div className="flex-1">
            <Title className="text-2xl text-primaryColor font-semibold">Havic HV G-92 Gamepad</Title>
            <div className="flex items-center gap-4 mt-4">
              <Flex className="items-center gap-2">
                <List className="flex gap-1">
                  {[...Array(5)].map((_, index) => <StarDesing key={index} />)}
                </List>
                <Text className="text-sm font-semibold text-primaryColor/50">(150 Reviews)</Text>
              </Flex>
            ...
            <div className="flex mt-6 gap-4">
              ...
              <div className="flex gap-2">
                <input className="w-5 h-5 rounded-full bg-red-500" id="colorred" type="radio" />
                <input className="w-5 h-5 rounded-full bg-blue-600" id="colorblue" type="radio" />
              </div>
            </div>
            <div className="flex mt-6 items-center gap-4">
              ...
              <div className="flex gap-2">
                {["XS", "S", "M", "L", "XL"].map((size) => (
                  <div key={size} className="w-8 h-8 border border-primaryColor/50 rounded-md flex justify-center items-center hover:bg-ThirdColor cursor-pointer">
                    <Text className="text-sm text-primaryColor hover:text-white">{size}</Text>
                  </div>
                ))}
              </div>
            </div>
            <div className="mt-6 flex gap-4">
              <div className="flex items-center border border-primaryColor/50 rounded-md overflow-hidden">
                <button className="w-10 h-10 flex justify-center items-center border-r border-primaryColor hover:bg-ThirdColor">-</button>
                <Text className="w-20 text-center">2</Text>
                <button className="w-10 h-10 flex justify-center items-center hover:bg-ThirdColor">+</button>
              </div>
              <div className="flex gap-4">
                <button className="py-2 px-4 bg-ThirdColor text-white rounded-md">Buy Now</button>
            ...
            <div className="w-full border-2 border-primaryColor/50 rounded-md mt-10">
              <div className="p-6 border-b border-primaryColor">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <Title className="text-base text-primaryColor">Free Delivery</Title>
                    <input className="text-sm text-primaryColor border-b mt-2 w-full outline-none placeholder:text-sm placeholder:text-primaryColor" placeholder="Enter your postal code" />
                  </div>
                </div>
              </div>
              <div className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <Title className="text-base text-primaryColor">Return Delivery</Title>
                    <Text className="text-sm text-primaryColor mt-2">Free 30 Days Delivery Returns. Details</Text>
                  </div>
                </div>
              </div>
            </div>
